package com.fatcat1978.mailrail.data.schedule.instruction;
...
public class FetchPackageExclusiveInstruction extends TextScheduleInstruction implements IFetchPackageExclusiveInstruction {

    @Override
    public Pair<ItemStack,Component> getSummary(){
        return Pair.of(getSecondLineIcon(), Mailrail.translateDirect("schedule.instruction.package_retrieval_exclusive"));
    }
    @Override
    public List<Component> getTitleAs(String type) {
        return ImmutableList.of(CreateLang.translate("schedule.instruction.package_retrieval.summary") //reusing this is easier
                        .style(ChatFormatting.GOLD)
                        .component(), CreateLang.translateDirect("generic.in_quotes", Component.literal(getLabelText())),
                Mailrail.translateDirect("schedule.instruction.package_retrieval_exclusive.summary_1")
                        .withStyle(ChatFormatting.GRAY),
                Mailrail.translateDirect("schedule.instruction.package_retrieval_exclusive.summary_2")
                        .withStyle(ChatFormatting.GRAY));
    }
    ...
    public List<Component> getSecondLineTooltip(int slot) {
        return ImmutableList.of(Mailrail.translateDirect("schedule.instruction.address_filter_edit_box"),
    ...
    public ResourceLocation getId() {
        return Mailrail.asResource("package_retrieval_exclusive");
    }
    ...
    @Override //huge, ugly as sin copypasta. Base Create
    public DiscoveredPath start(ScheduleRuntime runtime, Level level) {
        ...
        for (GlobalStation globalStation : train.graph.getPoints(EdgePointType.STATION)) {
            ...
            if(globalStation.getNearestTrain() != null)
                continue;
